...
button_frame = ttk.LabelFrame(win)
...
#竖排
#ttk.Label(button_frame, text='Label1').grid(column=0, row=0, sticky=tk.W)
ttk.Label(button_frame, text='---------------------------------isasolongLabel1-----------------').grid(column=0, row=0, sticky=tk.W)
...
for children in button_frame.winfo_children():
    children.grid_configure(padx=8, pady=4)
