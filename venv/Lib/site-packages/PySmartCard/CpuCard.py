...
class PcscReader(SmartCardAlgo):
    ...
    def power_on(self, readertype):
        ...
        Args:
            readertype: Specifies whether the currently used reader
                        is contact or contactless,
        ...
        if readertype != 1 and readertype != 2:
            raise Exception("the value of readertype[parameter]"
                            " must be 1 or 2  ")
        ...
        result = self.reader_lib.PowerOn_pcsc(self.handle, readertype)
        if result < 0:
            return -1
        else:
            return 0

    def send_apdu(self, apdu, readertype):
        """
        ...
        self.reader_lib.SendApdu_pcsc(self.handle, readertype, apdu, recv_info)
